  ...
  <main class="main">
    <teleport to="body">
      <BaseModal :isModalOpen="isCartModalOpen" type="cart" title="Ваша корзина">
        ...
        <p v-else>Ваша корзину пока пустая...</p>
        <template #actions>
    ...
    <teleport to="body">
      <BaseModal
        ...
        type="likes"
        title="Ваш список понравившихся товаров"
      >
        <Likes v-if="isLikes" @onClick="closeModal('likes')" />
        <p v-else>Сюда можно сохранить товары, которые вам понравились. Просто кликнув на сердечко.</p>
      </BaseModal>
    </teleport>

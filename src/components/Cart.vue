  ...
  <section class="cart">
    <div class="cart__mobile">
      <div class="cart__grid">
        ...
        <label class="cart__title">Наименование</label>
        <label class="cart__title">Количество</label>
        <label class="cart__title">Цена</label>
        <label class="cart__title">Сумма</label>
      </div>
    </div>
    ...
    <div class="cart__totals-block">
      <span class="cart__totals-block-title">Товаров в корзине:</span>
      <p>{{ totalProductsAddedToCart }} шт.</p>
    </div>
    <div class="cart__totals-block">
      <span class="cart__totals-block-title">Общая стоимость товаров: </span>
      <p>{{ totalAmount }} руб.</p>
    </div>

    <div class="cart__totals-block" v-if="delivery && delivery.name">
      <span class="cart__totals-block-title">Стоимость доставки:</span>
      <p>{{ deliveryPrice }} {{ !isFreeDelivery ? "руб." : "" }}</p>
    </div>

    <div class="cart__totals-block" v-if="delivery && delivery.name">
      <span class="cart__totals-block-title">Итого с учётом доставки:</span>
      <p>{{ total }} руб.</p>
    </div>
  </section>
</template>
